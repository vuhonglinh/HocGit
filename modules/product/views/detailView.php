                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                            ...
                            <div class="tp-product-details-inventory d-flex align-items-center mb-10">
                                ...
                                <div class="tp-product-details-rating-wrapper d-flex align-items-center mb-10">
                                    ...
                                    <div class="tp-product-details-reviews">
                                        <span>(<?php echo $count_evaluate; ?> Đánh giá)</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php endif ?>
                            <!-- variations -->
                            <h3 class="tp-product-details-action-title mt-10">Màu sắc :</h4>
                                <div class="tp-product-details-variation" id="color_var">
                                    <!-- single item -->
                                ...
                                <div class="tp-product-details-price-wrapper mb-20">
                                    ...
                                    <h3 id="product_price"><?php echo currency_format($product['price']) ?></h3>
                                </div>
                                <!-- actions -->
                        ...
                        <div class="tp-product-details-tab-nav tp-tab">
                            <nav>
                                <div class="nav nav-tabs justify-content-center p-relative tp-product-tab" id="navPresentationTab" role="tablist">
                                    ...
                                    <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" aria-controls="nav-review" aria-selected="false">Đánh giá (2)</button>
                                        ...
                                        <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-primaryStyle">
                                            <div class="tp-product-action-item-3 d-flex flex-column">
                                                ...
                                                <button type="button" class="tp-product-action-btn-3 tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                                                    ...
                                                    <span class="tp-product-tooltip">Xem lướt qua</span>
                                                </button>
                                                <button type="button" class="tp-product-action-btn-3 tp-product-add-to-wishlist-btn">
                                                    ...
                                                    <span class="tp-product-tooltip">Thêm vào danh sách yêu thích</span>
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="tp-product-details-variation-item">
                                ...
                                <div class="tp-product-details-variation-list">
                                    <button type="button" class="color tp-color-variation-btn">
                                        ...
                                        <span class="tp-color-variation-tootltip">Màu vàng</span>
                                    </button>
                                    <button type="button" class="color tp-color-variation-btn active">
                                        <span data-bg-color="#CBCBCB"></span>
                                        <span class="tp-color-variation-tootltip">Màu xám</span>
                                    </button>
                                    <button type="button" class="color tp-color-variation-btn">
                                        <span data-bg-color="#494E52"></span>
                                        <span class="tp-color-variation-tootltip">Màu đen</span>
                                    </button>
                                    <button type="button" class="color tp-color-variation-btn">
                                        <span data-bg-color="#B4505A"></span>
                                        <span class="tp-color-variation-tootltip">Màu nâu</span>
                                    </button>
                                </div>
                            </div>
                        </div>
