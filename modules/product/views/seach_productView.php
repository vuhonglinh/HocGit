                ...
                <div class="row d-flex">
                    <div class="col-md-6">
                        <div class="float-left">
                            <h3 class="font-weight-normal">KẾT QUẢ TÌM KIẾM: <?php echo $_GET['seach'] ?></h3>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="float-right">
                            <p class="">Hiển thị <?php if (!empty($seach_product)) {
                                                        echo count($seach_product);
                                                    } else {
                                                        echo "0";
                                                    } ?> sản phẩm</p>
                            <div class="">
