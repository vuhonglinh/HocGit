                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="tp-shop-sidebar mr-10">
                                            ...
                                            <label for="price1tr" data-bs-toggle="direct-bank-transfer">
                                                < 1 triệu</label>
                                                    <div class="tp-checkout-payment-desc direct-bank-transfer" style="display: none;">
                                                        <p>Tất cả các sản phẩm có giá dưới 1.000.000đ</p>
                                                    </div>
                                        </div>
                                        <div class="tp-checkout-payment-item">
                                            <input type="radio" name="price" value="2" id="price1_5tr">
                                            <label for="price1_5tr" data-bs-toggle="direct-bank-transfer">1 triệu - 5 triệu</label>
                                            <div class="tp-checkout-payment-desc direct-bank-transfer" style="display: none;">
                                                <p>Tất cả các sản phẩm có giá từ 1.000.000đ đến 5.000.000đ</p>
                                            </div>
                                        </div>
                                        <div class="tp-checkout-payment-item">
                                            <input type="radio" name="price" value="3" id="price5_15tr">
                                            <label for="price5_15tr" data-bs-toggle="direct-bank-transfer">5 triệu - 15 triệu</label>
                                            <div class="tp-checkout-payment-desc direct-bank-transfer" style="display: none;">
                                                <p>Tất cả các sản phẩm có giá từ 5.000.000đ đến 15.000.000đ</p>
                                            </div>
                                        </div>
                                        <div class="tp-checkout-payment-item">
                                            <input type="radio" name="price" value="4" id="price15_25tr">
                                            <label for="price15_25tr" data-bs-toggle="direct-bank-transfer">15 triệu - 25 triệu</label>
                                            <div class="tp-checkout-payment-desc direct-bank-transfer" style="display: none;">
                                                <p>Tất cả các sản phẩm có giá từ 15.000.000đ đến 25.000.000đ</p>
                                            </div>
                                        </div>
                                        <div class="tp-checkout-payment-item">
                                            <input type="radio" name="price" value="5" id="price25tr">
                                            <label for="price25tr" data-bs-toggle="direct-bank-transfer">> 25 triệu</label>
                                            <div class="tp-checkout-payment-desc direct-bank-transfer" style="display: none;">
                                                <p>Tất cả các sản phẩm có giá trên 25.000.000đ</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tp-shop-widget mb-50">
                            <h3 class="tp-shop-widget-title">Sản phẩm được mua nhiều nhất</h3>
                            <div class="tp-shop-widget-content">
                                            ...
                                            <div class="tp-shop-widget-product-item d-flex align-items-center">
                                                ...
                                                <div class="tp-shop-widget-product-content">
                                                    ...
                                                    <div class="tp-shop-widget-product-price-wrapper">
                                                        <span class="tp-shop-widget-product-price"><?php echo currency_format($item['price']) ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                    <?php endforeach;
                                    ...
                                    <form method="POST" action="">
                                        <div class="tp-shop-top-right d-sm-flex align-items-center justify-content-xl-end">
                                            ...
                                            <div class="tp-shop-top-filter">
                                                <button type="submit" name="loc" class="tp-filter-btn filter-open-btn">
                                                    <span>
                                                    ...
                                                    <div class="tp-product-item-2 mb-40">
                                                        ...
                                                        <div class="tp-product-content-2 pt-15">
                                                            ...
                                                            <div class="tp-product-price-wrapper-2">
                                                                <span class="tp-product-price-2 new-price"><?php echo currency_format($item['price']) ?></span>
                                                                <span class="tp-product-price-2 old-price"><?php echo currency_format($item['price']) ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
