                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="tp-shop-sidebar mr-10">
                            ...
                            <div class="tp-shop-widget-content">
                                <div class="tp-shop-widget-filter">
                                    ...
                                    <div class="tp-shop-widget-filter-info d-flex align-items-center justify-content-between">
                                        ...
                                        <button class="tp-shop-widget-filter-btn" type="button">Lọc</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tp-shop-widget mb-50">
                            <h3 class="tp-shop-widget-title">Trạng thái sản phẩm</h3>
                                ...
                                <div class="tp-shop-widget-checkbox">
                                    <ul class="filter-items filter-checkbox">
                                        ...
                                        <li class="filter-item checkbox">
                                            ...
                                            <label for="in_stock">Trong kho</label>
                                        </li>
                                    </ul><!-- .filter-items -->
                                </div>
                            </div>
                        ...
                        <!-- categories -->
                        <div class="tp-shop-widget mb-50">
                            <h3 class="tp-shop-widget-title">Loại</h3>

                            <div class="tp-shop-widget-content">
                                <div class="tp-shop-widget-categories">
                                    <ul>
                                        <li><a href="#">Iphone <span>10</span></a></li>
                                        <li><a href="#">Samsung <span>18</span></a></li>
                                        <li><a href="#">Xiaomi <span>22</span></a></li>
                                        <li><a href="#">Ipad<span>17</span></a></li>
                        ...
                        <!-- product rating -->
                        <div class="tp-shop-widget mb-50">
                            <h3 class="tp-shop-widget-title">Sản phẩm được đánh giá hàng đầu</h3>
                                ...
                                <div class="col-xl-6">
                                    <div class="tp-shop-top-left d-flex align-items-center ">
                                        ...
                                        <div class="tp-shop-top-result">
                                            <p>Hiển thị 1–14 trên 26 kết quả</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
