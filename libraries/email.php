...
function send_email($send_to_email, $send_to_fullname, $subject, $content, $option = array())
{
    ...
    try {
        ...
        //Attachments
        // $mail->addAttachment('banner1.jpg');         //Add attachments
        //$mail->addAttachment('banner1.jpg', 'linh.jpg');    //Optional name
        ...
        echo "Email không gửi được: Chi tiết lỗi: $mail->ErrorInfo";
    }
}
